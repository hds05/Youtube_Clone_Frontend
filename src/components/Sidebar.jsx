                ...
                <div className="fixed top-0 left-0 h-full bg-black text-white z-50 w-56 transition-transform duration-300 custom-scrollbar overflow-auto">
                    ...
                    <div className='p-4'>
                        ...
                        <div className='flex flex-col gap-2 pb-2 text-[15px] border-b-1 '>
                            ...
                            <div className='flex items-center gap-4 hover:bg-gray-800 p-2 rounded-lg cursor-pointer'>
                                <img src="https://img.freepik.com/premium-vector/icon-design-fundamentals-crafting-perfect-vector-art-illustrations_1301270-3868.jpg?semt=ais_hybrid&w=740&q=80" alt="youtube_premium" className='rounded-full' width={22} />
                                <span>YouTube Premium</span>
                            </div>
                            <div className='flex items-center gap-4 hover:bg-gray-800 p-2 rounded-lg cursor-pointer'>
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Youtube_Music_icon.svg/3840px-Youtube_Music_icon.svg.png" alt="youtube_music" width={22} />
                                <span>YouTube Music</span>
                            </div>
                            <div className='flex items-center gap-4 hover:bg-gray-800 p-2 rounded-lg cursor-pointer'>
                                <img src="https://static.vecteezy.com/system/resources/thumbnails/017/396/821/small_2x/youtube-kids-google-apps-logo-free-png.png" alt="youtube_kids" width={22} />
                                <span>YouTube Kids</span>
                            </div>
                        </div>

                        <div className='flex flex-col gap-2 py-2 text-[15px] border-b-1 '>
                            <div className='flex items-center gap-4 hover:bg-gray-800 p-2 rounded-lg cursor-pointer'>
                                <CiFlag1 size={22} />
                                <span>Report history</span>
                            </div>
                        </div>
                        <div className='text-[12px] p-4 flex flex-col gap-2'>
